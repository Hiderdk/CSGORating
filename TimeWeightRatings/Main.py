...
from TimeWeightRatings.PerformanceRating import *
from TimeWeightRatings.SingleSeries import SingleSeriesRating
from Functions.ChangeDataFrame import *
from aws import *
from TimeWeightRatings.PlayerRoundWins import PlayerRoundWinsGenerator
import time
...
class AllGamesGenerator():
    ...
    def calculcate_rating_for_all_series(self,series_ids):
        ...
        for series_number, series_id in enumerate(series_ids):
            ...
            SingleSeries = SingleSeriesRating(series_id)
            SingleSeries.main(self)
